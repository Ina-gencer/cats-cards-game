...
class AudioController {
    constructor() {
        this.bgMusic = new Audio('kukutiki-pyat-kotyat.mp3');
        /*фоновая музыка; this ссылается на объект, «владеющий» кодом, выполняемым в текущий момент.*/
        this.flipSound = new Audio('2audio.wav');
        this.matchSound = new Audio('otvet.mp3');
        this.victorySound = new Audio('pobeda.mp3');
